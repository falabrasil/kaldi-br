...
ln -sf $ASPIRE_DIR/steps/ $PROJECT_DIR
ln -sf $ASPIRE_DIR/utils/ $PROJECT_DIR

ln -sf $ASPIRE_DIR/path.sh $PROJECT_DIR/path.sh
sed 's/"queue.pl/"run.pl/g' $ASPIRE_DIR/cmd.sh > $PROJECT_DIR/cmd.sh
